...
const DateTimeRangePicker = ({ 
  ...
  return (
    <div className="date-time-range-picker">
      ...
      />
      <div className="time-selection" style={{ display: 'flex', alignItems: 'center', gap: '4px' }}>
        <div className="start-time" style={{ display: 'flex', alignItems: 'center', gap: '4px' }}>
        ...
        <span>-</span>
        <div className="end-time" style={{ display: 'flex', alignItems: 'center', gap: '4px' }}>
